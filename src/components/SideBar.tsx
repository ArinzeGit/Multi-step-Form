...
const SideBar = () => {
  ...
  return (
    <div className="bg-[url('/src/assets/images/bg-sidebar-mobile.svg')] desktop:bg-[url('/src/assets/images/bg-sidebar-desktop.svg')] min-h-[172px] desktop:min-h-[568px] desktop:w-[274px] bg-cover bg-no-repeat bg-center pt-8 flex justify-center gap-4 desktop:block desktop:px-[32px] desktop:py-[40px]">
